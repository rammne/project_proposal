...
const slides: Slide[] = [
  {
    ...
    footer: "Prepared by Rame Nicholas G. Tiongson",
  },
  {
    id: 2,
    type: "split",
    ...
    content: {
      points: [
        ...
        {
          icon: Smartphone,
          text: "Bleeding enrollments due to mobile incompatibility",
        },
      ],
    },
  },
  ...
  },
  {
    ...
    content: {
      text: "We will push the Reddit thread to Page 2.",
    },
  },
  {
    id: 6,
    ...
    content: {
      ...
      argument:
        "This is a self-healing, secure, containerized system. We own the code.",
    },
  },
  {
    id: 7,
  ...
  },
  {
    ...
    content: {
      ...
      narrative:
        "Equivalent to the tuition of just 1.5 students. If this saves 2 enrollments, it pays for itself.",
    },
  },
  {
    id: 10,
  ...
  },
  {
    ...
    subtitle:
      "Let's turn our digital presence from a liability into our strongest asset.",
  },
];
            ...
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{
                  marginTop: -48,
                  marginLeft: -48,
                  transform: `rotate(${i * 120}deg) translate(180px) rotate(-${
                    i * 120
                  }deg)`,
                }}
              >
      ...
      return (
        <div className="w-full">
          ...
          <div className="relative">
            <div className="absolute top-1/2 left-0 w-full h-1 bg-slate-800 -translate-y-[54px]" />
